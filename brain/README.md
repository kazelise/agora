...
设计理由写在 [docs/design.md](../docs/design.md) 的 Phase 2 / Phase 4b / Phase 4c 三节。入口是 `brain.graph.Brain` / `make_turn_fn`。云端 Job 的一次性入口是 `python -m brain.job`（HttpWorld + cluster token）。
